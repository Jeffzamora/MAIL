...
<div class="contact">
	...
	<form method="post">
		...
		<input type="email" placeholder="your@email.com" class="hola"  name="email" required />
		
		<h3>Tu nombre</h3>
		<input type="text" placeholder="Your name" class="hola"  name="name" required />
		<h3>Asunto</h3>
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username="no-reply@logicsa.net";//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword="Soporte02";//Tu contraseña de gmail
				$mail_addAddress="informatica.lc@logicsa.net";//correo electronico que recibira el mensaje
